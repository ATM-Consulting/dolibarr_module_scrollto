...
class modScrollTo extends DolibarrModules
{
	...
	function __construct($db)
	{
        ...
        */
		...
		//							'position'=>100,
		//							'enabled'=>'isModEnabled("scrollto")',	// Define condition to show or hide menu entry. Use 'isModEnabled("scrollto")' if entry must be visible if module is enabled.
		//							'perms'=>'1',			                // Use 'perms'=>'$user->hasRight("scrollto", "level1", "level2")' if you want your menu with a permission rules
		//							'target'=>'',
